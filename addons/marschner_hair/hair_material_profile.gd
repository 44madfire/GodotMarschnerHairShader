...
## 0 = Approx/Kajiya-Kay, 1 = Unity Fast, 2 = Cinematic.
enum QualityTier {
	APPROX = 0,
	FAST_MARSCHNER = 1,
...
## Remaining Marschner TT/TRT transport at full wetness. Approx retains it only
...
## direct ImageTexture3D at res://addons/marschner_hair/luts/unity_azimuthal_64.res.
